...
public class DateUtil {
     ...
     * @return
     */
    public static Date getNextMonthFirstDay(int y, int m) {
     ...
     * @return
     */
    public static Date getSeasonFirstDay(int y, int m) {
        int month = 0;
        switch (m) {
            case 1:
            case 2:
        ...
        return getDate(y, month, 1);

    }

    public static Date getNextSeasonFirstDay(int y, int m) {
        int month = 0;
        switch (m) {
            case 1:
            case 2:
        ...
        return getDate(y, month + 3, 1);

    }

    public static Date getYearFirstDay(int y) {
        return getDate(y, 1, 1);
    }

    public static Date getNextYearFirstDay(int y) {
